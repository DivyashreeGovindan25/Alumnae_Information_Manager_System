          ...
          if(mysqli_num_rows($result)==0)
          {
             ...
             if(mysqli_num_rows($result3)==0)
             {
               ...
               else
               {
                ...
                {        
                     $insert="INSERT INTO  alumnae_details (fname,lname,reg_no,batch,dob,department,yop,email,contact,watsapp,address,city,state,zipcode,occupation) VALUES ('$fname_upper','$lname_upper','$reg_no_upper','$batch_id_upper','$dob','$department_upper','$year_of_passing','$email_lower','$contact','$wats_app','$address_upper','$city_upper','$state_upper','$zipcode','$occupation_upper')  ";       
