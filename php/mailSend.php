...
if (isset($_POST["send-mail"])) 
{
         ...
         foreach ($array_emails as $value) 
         {
            ...
            try
            {
               ...
               $mail->SMTPAuth = true;
               $mail->Username = 'divyashreeharitha@gmail.com'; // Gmail address which you want to use as SMTP server
               $mail->Password = 'haritha@3210'; // Gmail address Password
               $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
               $mail->Port = '587';

               $mail->setFrom('divyashreeharitha@gmail.com'); // Gmail address which you used as SMTP server
