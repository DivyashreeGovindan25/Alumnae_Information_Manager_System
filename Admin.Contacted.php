...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/Admin.Contacted.css">
      ...
      <div class="main-content">
        <header>
          <div class="search-wrapper">
            ...
            <input type="search" name="search-data" id="search-data" placeholder="Search">
          </div>
        </header>
      </div>
             ...
             <tbody>
              <?php
               ...
               if(mysqli_num_rows($result2)>0)
               {
                 ...
                 {
                    echo "<tr><td>".$row["id"]. "</td><td>".$row["name"]. "</td><td>".$row["reg_no"]. "</td><td>".$row["email"]. "</td><td>".$row["message"]. "</td></tr>";
                  }
                  echo "</table>";
                }
                else
